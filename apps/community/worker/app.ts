import { consumeQuota, type QuotaLimits } from '@dsh-1024store/core/api-quota'
import { sanitizeReturnTo } from '@dsh-1024store/core/auth'
import { normalizePluginId, parsePluginId } from '@dsh-1024store/core/plugin-id'
import { Hono } from 'hono'
import type { ApiError, CommunityStats, FeedResponse, ThreadResponse, Viewer } from './lib/contract'
import {
  communityStats,
  createPost,
  deletePost,
