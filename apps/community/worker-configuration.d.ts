/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3dbc1f40f910aad1e65ef3b7eea0d612)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COMMUNITY_ADMIN_LOGINS">> {}
}
