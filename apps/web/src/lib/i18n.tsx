...
const messages = {
  en: {
    ...
    catalogSeoTitle: 'DeepSeek Harness Plugins & Extensions | DSH 1024Store',
    ...
    rankingsIntro: 'Every listing passes DSH plugin spec checks and screening first. Then compare community plugins by wrapper-CLI install reports, GitHub stars, releases, and repository activity to find established and emerging tools.',
    rankingsSeoTitle: 'DeepSeek Harness Plugin Rankings | DSH 1024Store',
    rankingsSeoDescription: 'Compare popular DeepSeek Harness plugins by anonymous install activity, GitHub stars, releases, and repository activity in the community plugin rankings.',
    ...
    installBenefitsLine: 'Counts toward install rankings · Args pass through to the official CLI · Anonymous stats only · Open source',
  ...
  zh: {
    ...
    catalogSeoTitle: 'DeepSeek Harness 插件与扩展 | DSH 1024Store',
    ...
    rankingsIntro: '收录插件均先经 DSH 插件规范检查与过滤，再按包装 CLI 上报的安装记录、GitHub Star、发布记录与仓库活跃度比较，发现成熟工具与潜力新项目。',
    rankingsSeoTitle: 'DeepSeek Harness 插件排行榜 | DSH 1024Store',
    rankingsSeoDescription: '查看 DeepSeek Harness 社区插件排行榜，比较匿名安装活跃度、GitHub Star、发布记录与仓库活跃度。',
    allPackages: '全部插件',
    search: '搜索插件',
    ...
    installBenefitsLine: '计入安装排行 · 参数透传官方 CLI · 仅匿名统计 · 源码开源',
