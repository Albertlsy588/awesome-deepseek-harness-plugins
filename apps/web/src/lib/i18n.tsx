...
const messages = {
  en: {
    ...
    rankingsTitle: 'Community package rankings',
    rankingsSubtitle: 'See what the community is starring, publishing, and actively maintaining.',
    catalogTitle: 'Explore community packages',
    catalogSubtitle: 'Find focused extensions for every part of your DeepSeek Harness workflow.',
    categoryCount: 'Categories',
    metricsCoverage: 'GitHub data',
  ...
  zh: {
    ...
    rankingsTitle: '社区插件排行榜',
    rankingsSubtitle: '看看社区正在关注、发布和持续维护哪些 DeepSeek Harness 插件。',
    catalogTitle: '探索社区插件',
    catalogSubtitle: '按能力和使用场景，找到适合你的 DeepSeek Harness 扩展。',
    categoryCount: '分类',
    metricsCoverage: 'GitHub 数据',
    allPackages: '全部插件',
    search: '搜索插件',
