...
const messages = {
  en: {
    ...
    rankingsIntro: 'Compare community plugins by wrapper-CLI install reports, GitHub stars, releases, and repository activity to find established and emerging tools.',
  ...
  zh: {
    ...
    rankingsIntro: '按包装 CLI 上报的安装记录、GitHub Star、发布记录与仓库活跃度比较社区插件，发现成熟工具与潜力新项目。',
