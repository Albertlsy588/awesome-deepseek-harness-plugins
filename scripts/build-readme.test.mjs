  ...
  plugins: [
    {
      ...
      install: 'npx @dsh-1024store/cli add owner/zeta --profile web',
      added: '2026-08-01',
      stars: 12,
    },
    {
      ...
      install: 'npx @dsh-1024store/cli add owner/alpha --profile web',
      added: '2026-08-02',
      stars: null,
    },
    {
      ...
      install: 'npx @dsh-1024store/cli add someone/scanned --profile web',
      added: '2026-08-10',
      stars: 3,
    },
    {
      ...
      install: 'npx @dsh-1024store/cli add owner/ui-thing --profile web',
      added: '2026-08-03',
      stars: 0,
    },
  ],
...
test('adapts the legacy /plugins.json shape', () => {
  const legacy = {
    ...
    plugins: [{
      ...
      install: 'npx @dsh-1024store/cli add Owner/Repo-Name --profile web',
      added: '2026-08-01',
    }],
  }
