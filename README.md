...
面向 [DeepSeek Harness](https://github.com/deepseek-ai/DeepSeek-Harness)（`dsh`）生态的社区插件目录，共收录 **11291** 个插件（含 PR 收录与 GitHub `dsh-plugin` topic 自动发现），目录数据更新于 2026-08-26。
...
[![DSH 1024Store 插件市场首页](https://raw.githubusercontent.com/imsai-sh/awesome-deepseek-harness-plugins/assets/homepage.zh.png?v=a96c2d50af11)](https://deepseek1024.com/)
...
- [工具与能力](#tools) (3266)
- [技能包](#skill) (1082)
- [工作流与自动化](#workflow) (583)
- [通知与集成](#notify) (419)
- [模型与账号接入](#model) (638)
- [开发与运行时](#dev) (1254)
- [娱乐](#fun) (464)
- [待分类](#unclassified) (100)
...
<details>
<summary><strong>工具与能力</strong> · 显示 258 / 共 3266 个</summary>
...
- *GitHub 单个文件能渲染的长度有上限，本分类还有 3008 个插件没能列在这里；完整目录请在[在线网站](https://deepseek1024.com/)搜索浏览。*
...
<details>
<summary><strong>工作流与自动化</strong> · 显示 254 / 共 583 个</summary>
...
- *GitHub 单个文件能渲染的长度有上限，本分类还有 329 个插件没能列在这里；完整目录请在[在线网站](https://deepseek1024.com/)搜索浏览。*
...
<details>
<summary><strong>开发与运行时</strong> · 显示 262 / 共 1254 个</summary>
...
- *GitHub 单个文件能渲染的长度有上限，本分类还有 992 个插件没能列在这里；完整目录请在[在线网站](https://deepseek1024.com/)搜索浏览。*
...
<details>
<summary><strong>待分类</strong> · 显示 0 / 共 100 个</summary>
