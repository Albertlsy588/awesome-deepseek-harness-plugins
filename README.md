# Awesome DeepSeek Harness Plugins · DSH 1024Store

<!-- 本文件由 scripts/build-readme.mjs 从 deepseek1024.com 目录 API 自动生成，请勿手工编辑。 -->

> **DeepSeek Harness 插件市场 / 插件商店 / 插件目录**（plugin store / plugin market / plugin hub），面向 [DeepSeek Harness](https://github.com/deepseek-ai/DeepSeek-Harness)（`dsh`）生态，共收录 **2,988** 个 dsh 插件，分为 11 个分类，数据更新于 2026-08-16。想搜索、筛选、按安装量排序或直接安装，请访问 [DeepSeek Harness 插件市场 deepseek1024.com](https://deepseek1024.com/)。

收录来源包括 PR 提交与 GitHub `dsh-plugin` topic 自动发现。每个插件由各自作者独立开发和维护，收录仅表示其通过了目录的基础格式校验。

[浏览 DeepSeek Harness 插件商店](https://deepseek1024.com/plugins) · [dsh 插件安装量排行榜](https://deepseek1024.com/) · [English plugin catalog](catalog/README.md) · [提交你的 dsh 插件](CONTRIBUTING.md)
...
## 如何安装 DeepSeek Harness 插件 / How to install a DeepSeek Harness plugin
...
- **在线插件市场**：提供功能较完整的 [DeepSeek Harness 插件商店 deepseek1024.com](https://deepseek1024.com/) 网站，支持搜索、分类筛选、排行榜、插件详情及 GitHub 活跃度数据浏览。
...
- … 还有 17 个插件 — [在 DSH 1024Store 浏览完整的「UI 增强」插件列表](https://deepseek1024.com/plugins?category=ui)
...
- … 还有 32 个插件 — [在 DSH 1024Store 浏览完整的「工具与能力」插件列表](https://deepseek1024.com/plugins?category=tools)
...
- … 还有 5 个插件 — [在 DSH 1024Store 浏览完整的「开发与运行时」插件列表](https://deepseek1024.com/plugins?category=dev)
...
还有 **2,717** 个插件等待分类 —— [到 DSH 1024Store 插件市场浏览它们](https://deepseek1024.com/plugins)，或[帮忙给它们归类](CONTRIBUTING.md)。
