...
> This file is generated from `catalog/plugins/*.json`. Do not edit it directly.
...
Read the root [CONTRIBUTING.md](../CONTRIBUTING.md) and submit one new structured plugin file.
